...
// We don't need Nango for this simple setup, let's keep it clean
        ...
        <Card className="border-none shadow-sm bg-slate-900">
            ...
            <CardContent className="space-y-4">
                <div className="bg-black p-4 rounded-lg flex items-center justify-between">
                    ...
                    <Button size="icon" variant="ghost" className="text-white hover:bg-slate-700" onClick={copyToClipboard}>
